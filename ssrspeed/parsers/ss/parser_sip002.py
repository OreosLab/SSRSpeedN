...
if __name__ == "__main__":
    ...
    parser = ParserShadowsocksSIP002(config)
    links_ = b64plus.decode(
    ...
    for i in links_.splitlines():
        print(parser.parse_single_link(i))
    link_ = "ss://cmM0LW1kNTpwYXNzd2Q=@192.168.100.1:8888/?plugin=obfs-local%3Bobfs%3Dhttp#Example2"
    print(parser.parse_single_link(link_))
