...
class Manager(object):
    ...
    def add_port(self, config):
        ...
        t = tcprelay.TCPRelay(
            config, self._dns_resolver, False, stat_callback=self.stat_callback
        )
        u = udprelay.UDPRelay(
            config, self._dns_resolver, False, stat_callback=self.stat_callback
        )
    ...
    def handle_periodic(self):
        ...
        def send_data(data_dict):
            if data_dict:
                ...
                data = common.to_bytes(json.dumps(data_dict, separators=(",", ":")))
...
def test():
    ...
    def run_server():
        ...
        a_config = {
            "server": "127.0.0.1",
            "local_port": 1081,
            "port_password": {"8381": "foobar1", "8382": "foobar2"},
            "method": "aes-256-cfb",
    ...
    data = encrypt.encrypt_all(
        b"asdfadsfasdf", "aes-256-cfb", 1, header + b"GET /\r\n\r\n"
    )
